...
export default function ProgressNotesPanel({
  ...
  return (
    <div className="sf-notes">
      ...
      {open && (
        <div
          className="sf-notes__backdrop"
          role="dialog"
          aria-modal="true"
          aria-labelledby="sf-notes-title"
          onClick={() => setOpen(false)}
        >
          <div className="sf-notes__dialog" onClick={(e) => e.stopPropagation()}>
            <div className="sf-notes__header">
              <div className="sf-notes__eyebrow" id="sf-notes-title">
